-- Analytics Infrastructure for Advanced Reporting Dashboard
-- Create views and functions for efficient data aggregation and analytics

-- Daily analytics view for appointment statistics
CREATE OR REPLACE VIEW analytics_daily_appointments AS
SELECT 
...
-- Monthly revenue analytics view
...
CREATE OR REPLACE VIEW analytics_patient_flow AS
SELECT 
...
CREATE OR REPLACE VIEW analytics_staff_performance AS
SELECT 
  a.staff_id,
...
-- Appointment type distribution view
CREATE OR REPLACE VIEW analytics_appointment_types AS
SELECT 
  appointment_type,
  branch_id,
  tenant_id,
...
-- Queue performance analytics view
CREATE OR REPLACE VIEW analytics_queue_performance AS
SELECT 
...
-- Function to get appointment analytics for date range
...
-- Function to get revenue analytics for date range
...
-- Function to get patient flow analytics
