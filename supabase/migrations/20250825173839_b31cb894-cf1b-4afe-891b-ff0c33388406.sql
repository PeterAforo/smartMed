-- Insert sample AI insights data for testing (with correct insight_type values)
...
(
  ...
  ARRAY['bed_management_system', 'patient_tracking', 'staff_scheduling'],
...
(
  ...
  ARRAY['staffing_system', 'patient_acuity_tracking'],
...
(
  ...
  ARRAY['appointment_system', 'financial_tracking', 'patient_communication'],
  now() + interval '7 days'
),
(
  (SELECT id FROM public.tenants WHERE code = 'DEFAULT' LIMIT 1),
  ...
  ARRAY['equipment_tracking', 'scheduling_system'],
  now() + interval '5 days'
),
...
(
  ...
  '[]',
  ARRAY['patient_surveys', 'feedback_system', 'quality_metrics'],
...
(
  ...
  ARRAY['ehr_system', 'predictive_analytics', 'patient_outcomes'],
  now() + interval '3 days'
),
...
(
  ...
  ARRAY['supply_chain_system', 'financial_tracking', 'vendor_management'],
...
(
  ...
  ARRAY['scheduling_system', 'patient_flow_tracking'],
...
(
  ...
  ARRAY['pharmacy_system', 'inventory_tracking'],
  now() + interval '1 day'
);